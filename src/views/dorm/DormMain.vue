<template>
	<a-layout id="components-layout-demo-custom-trigger">
		<a-layout-sider v-model="collapsed" :trigger="null" collapsible>
			<img class="logo" src="../../assets/timg.jpg"></img><span v-if="!collapsed" class="logo">宿舍管理系统</span>
			</div>
			...
			<a-layout-header style="background: #fff; padding: 0">
				<div class="headBar">
					...
					<div class="right">
						...
						<a href="javascript:;" style="color: #000000;" @click="handleLogout">退出登录</a>
					</div>
				</div>
			</a-layout-header>
...
<script>
	...
	import leftBar from '@/views/dorm/menu/leftBar.vue'
