...
export const asyncRouterMap = [
	...
	{ // 首页默认菜单
		...
		children: [{
			...
			name: 'baseData',
			component: () => import('@/views/common/basicsData/index')
		}],
	}, {
		// 首页默认菜单
		path: '/kqManage',
		...
		children: [{
			...
			},
			{
				...
				meta: {
					title: '考勤申请',
					roles: ['system', 'student','teacher'],
					breadcrumbs: ['考勤管理', '考勤申请'],
				},
				name: 'myLeave',
				component: () => import('@/views/stuManage/kqManage/view/myLeave/myLeaveApply')
			}
	...
	},
	{
		...
		redirect: '/yygl/veStuYyproject/veStuYyproject',
		children: [{
				//考勤管理
				path: '/yygl/veStuYyproject/veStuYyproject',
				meta: {
					title: '我要预约',
					roles: ['system','student'],
			...
			{
				//角色管理
				path: '/yygl/veStuYystu/veStuYystu',
				meta: {
					title: '我的预约',
					roles: ['system','student'],
	...
	}, 
	{
		...
		children: [{
			...
			},
			{
				...
				component: () => import('@/views/jwManage/kwgl/kaoshi/mykaoshi')
			},
			{
				path: '/kwgl/bukao',
				meta: {
	...
	},
	{
		...
		redirect: '/dormsw/dormModifyApply',
		children: [{
	...
	{ // 首页默认菜单
		...
		redirect: '/department/operationLog/index',
		children: [
			{
				//部门管理
				path: '/department/departmentManagement/index',
				meta: {
					title: '部门管理',
					roles: ['system'],
					breadcrumbs: ['部门管理', '部门管理'],
				},
				name: 'dictionaryManagement',
				component: () => import('@/views/common/departmentManagement/index')
			},
		]
	},
	...
	{ // 首页默认菜单
		...
		children: [
			...
			{
				//流程表单预览测试
				path: '/processManagement/processList/content',
				meta: {
					title: '流程表单预览测试',
					roles: ['system'],
					breadcrumbs: ['系统管理', '流程表单预览测试'],
				},
				name: 'content',
				component: () => import('@/views/common/processList/content')
			},
			{
				//流程表单管理
